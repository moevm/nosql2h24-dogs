...
public class BreedController {
    ...
    @PostMapping("/bodySearch/{breedsPerPages}/{pageNumber}")
    public List<BreedInfo> bodySearchBreed(@RequestBody Filter filter, @PathVariable int breedsPerPages, @PathVariable int pageNumber) {
